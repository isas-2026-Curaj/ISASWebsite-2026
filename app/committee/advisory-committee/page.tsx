        ...
        <div className="w-full">
          ...
          <div className="grid md:grid-cols-3 gap-x-10 gap-y-6 text-center text-sm text-muted-foreground leading-relaxed">
            {[
              ...
              ["Dr. Anoop Chaturvedi", "Prof., University of Allahabad"],
              ...
              ["Dr. Shalabh", "Prof., IIT Kanpur"],
              ["Dr. Narender Kumar", "Dean, Panjab University, Chandigarh"],
              ["Prof. Neeraj Tiwari", "Head, SSJU University, Almora"],
              ["Dr. Padi Tirupati Rao", "Prof. & Head, Pondicherry University, Puducherry"],
              ["Dr. J.K. Prajapat", "Prof. & Ex-Dean, CURaj, Ajmer"],
              ...
              ["Dr. Amita Sharma", "Prof., Rajasthan University, Jaipur"],
